    ...
    public static function checkLogin() {
        if(!empty($_SESSION['token'])) {
            ...
            if((bool) $data) {
                ...
                $loggedUser->editar_foto = $data['editar_foto'];
                ...
                $loggedUser->pct_inativos = $data['pct_inativos'];
                $loggedUser->admin = $data['admin'];

                $loggedUser->divPrimaria = $data['divPrimaria'];
                $loggedUser->divSecundaria = $data['divSecundaria'];
                $loggedUser->resumo = $data['resumo'];
                $loggedUser->pacientes = $data['pacientes'];
                $loggedUser->calendario = $data['calendario'];
                $loggedUser->notificacao = $data['notificacao'];
                $loggedUser->atalhos = $data['atalhos'];
                $loggedUser->noticias = $data['noticias'];
                $loggedUser->tamanhoPacientes = $data['tamanhoPacientes'];
                $loggedUser->email_marketing = $data['email_marketing'];
